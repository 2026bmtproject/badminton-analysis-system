...
def _append_pair_fact(
    ...
    *,
    ...
    if pair and all(s.confidence_band == "reliable" and s.player is not None for s in pair):
        local_facts.append(
            _local_fact(
                fact,
                name=name,
...
def _analyze_local_facts(
    ...
    if triple and all(s.confidence_band == "reliable" and s.player is not None for s in triple):
        local_facts.append(
            _local_fact(
                fact,
...
def analyze_stroke_events(
    ...
    *,
    ...
    """Analyze every hit; compatibility speaking fields never gate inclusion."""
