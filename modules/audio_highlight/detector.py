...
from modules.audio_highlight.yamnet import (
    YAMNET_EMBEDDING_SIZE,
    YAMNET_MODEL_HANDLE,
)
from modules.audio_highlight.audio import YAMNET_SAMPLE_RATE_HZ
from modules.audio_highlight.windows import InferenceConfig
